    ...
    return (
        <section className='register information'>
            ...
            <form className='information__form' onSubmit={handleSubmit(submit)}>
                ...
                <input className='information__form-input' type='text' name = 'name' id='name'
                       {...register('name', {required: true,
                            minLength: 2, maxLength: 30, pattern: /[a-zа-яё ]/i})}/>
                <span className='information__form-input-error-text'>
                ...
                <input className='information__form-input' type='email' name = 'email' id='email'
                ...
                <input className='information__form-input'
                       type='password' required name ='password' id='password'
                       {...register('password', {required: true})}/>
                <span className='information__form-input-error-text'>
                    {errors.password?.type === "required" && "Пожалуйста, заполните поле"} </span>

                <span className={'information__form-input-error' +  (isErrorMessage?' information__form-input-error_visible ':'')}>Во время регистрации произошла ошибка</span>
